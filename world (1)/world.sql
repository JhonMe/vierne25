...
-- Volcando estructura para tabla information_schema.ADMINISTRABLE_ROLE_AUTHORIZATIONS
...
-- Volcando estructura para tabla information_schema.COLUMNS_EXTENSIONS
...
-- Volcando estructura para tabla information_schema.COLUMN_STATISTICS
...
-- Volcando estructura para tabla information_schema.INNODB_CACHED_INDEXES
...
-- Volcando estructura para tabla information_schema.INNODB_COLUMNS
...
-- Volcando estructura para tabla information_schema.INNODB_DATAFILES
...
-- Volcando estructura para tabla information_schema.INNODB_FIELDS
...
-- Volcando estructura para tabla information_schema.INNODB_FOREIGN
...
-- Volcando estructura para tabla information_schema.INNODB_FOREIGN_COLS
...
-- Volcando estructura para tabla information_schema.INNODB_INDEXES
...
-- Volcando estructura para tabla information_schema.INNODB_SESSION_TEMP_TABLESPACES
...
-- Volcando estructura para tabla information_schema.INNODB_TABLES
...
-- Volcando estructura para tabla information_schema.INNODB_TABLESPACES
...
-- Volcando estructura para tabla information_schema.INNODB_TABLESPACES_BRIEF
...
-- Volcando estructura para tabla information_schema.INNODB_TABLESTATS
...
-- Volcando estructura para tabla information_schema.INNODB_VIRTUAL
...
-- Volcando estructura para tabla information_schema.RESOURCE_GROUPS
...
-- Volcando estructura para tabla information_schema.ROLE_COLUMN_GRANTS
...
-- Volcando estructura para tabla information_schema.ROLE_ROUTINE_GRANTS
...
-- Volcando estructura para tabla information_schema.ROLE_TABLE_GRANTS
...
-- Volcando estructura para tabla information_schema.SCHEMATA_EXTENSIONS
...
-- Volcando estructura para tabla information_schema.ST_GEOMETRY_COLUMNS
...
-- Volcando estructura para tabla information_schema.ST_SPATIAL_REFERENCE_SYSTEMS
...
-- Volcando estructura para tabla information_schema.ST_UNITS_OF_MEASURE
...
-- Volcando estructura para tabla information_schema.TABLESPACES_EXTENSIONS
...
-- Volcando estructura para tabla information_schema.TABLES_EXTENSIONS
...
-- Volcando estructura para tabla information_schema.TABLE_CONSTRAINTS_EXTENSIONS
...
-- Volcando estructura para tabla information_schema.USER_ATTRIBUTES
...
-- Volcando estructura para tabla information_schema.VIEW_ROUTINE_USAGE
...
-- Volcando estructura para tabla information_schema.VIEW_TABLE_USAGE
...
-- Volcando estructura para tabla mysql.component
...
-- Volcando estructura para tabla mysql.default_roles
...
-- Volcando estructura para tabla mysql.global_grants
...
-- Volcando estructura para tabla mysql.password_history
...
-- Volcando estructura para tabla mysql.replication_asynchronous_connection_failover
...
-- Volcando estructura para tabla mysql.replication_asynchronous_connection_failover_managed
...
-- Volcando estructura para tabla mysql.replication_group_configuration_version
...
-- Volcando estructura para tabla mysql.replication_group_member_actions
...
-- Volcando estructura para tabla mysql.role_edges
...
-- Volcando estructura para tabla performance_schema.binary_log_transaction_compression_stats
CREATE TABLE IF NOT EXISTS `binary_log_transaction_compression_stats` (
...
-- Volcando estructura para tabla performance_schema.data_locks
...
-- Volcando estructura para tabla performance_schema.data_lock_waits
...
-- Volcando estructura para tabla performance_schema.error_log
...
-- Volcando estructura para tabla performance_schema.events_errors_summary_by_account_by_error
...
-- Volcando estructura para tabla performance_schema.events_errors_summary_by_host_by_error
...
-- Volcando estructura para tabla performance_schema.events_errors_summary_by_thread_by_error
...
-- Volcando estructura para tabla performance_schema.events_errors_summary_by_user_by_error
...
-- Volcando estructura para tabla performance_schema.events_errors_summary_global_by_error
...
-- Volcando estructura para tabla performance_schema.events_statements_histogram_by_digest
...
-- Volcando estructura para tabla performance_schema.events_statements_histogram_global
...
-- Volcando estructura para tabla performance_schema.innodb_redo_log_files
CREATE TABLE IF NOT EXISTS `innodb_redo_log_files` (
...
-- Volcando estructura para tabla performance_schema.keyring_component_status
CREATE TABLE IF NOT EXISTS `keyring_component_status` (
...
-- Volcando estructura para tabla performance_schema.keyring_keys
...
-- Volcando estructura para tabla performance_schema.log_status
...
-- Volcando estructura para tabla performance_schema.persisted_variables
...
-- Volcando estructura para tabla performance_schema.processlist
...
-- Volcando estructura para tabla performance_schema.replication_applier_filters
...
-- Volcando estructura para tabla performance_schema.replication_applier_global_filters
...
-- Volcando estructura para tabla performance_schema.replication_asynchronous_connection_failover
CREATE TABLE IF NOT EXISTS `replication_asynchronous_connection_failover` (
  `CHANNEL_NAME` char(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'The replication channel name that connects source and replica.',
  `HOST` char(255) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL COMMENT 'The source hostname that the replica will attempt to switch over the replication connection to in case of a failure.',
...
-- Volcando estructura para tabla performance_schema.replication_asynchronous_connection_failover_managed
CREATE TABLE IF NOT EXISTS `replication_asynchronous_connection_failover_managed` (
  `CHANNEL_NAME` char(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'The replication channel name that connects source and replica.',
  `MANAGED_NAME` char(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT 'The name of the source which needs to be managed.',
  `MANAGED_TYPE` char(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT 'Determines the managed type.',
...
-- Volcando estructura para tabla performance_schema.setup_threads
...
-- Volcando estructura para tabla performance_schema.tls_channel_status
CREATE TABLE IF NOT EXISTS `tls_channel_status` (
...
-- Volcando estructura para tabla performance_schema.user_defined_functions
...
-- Volcando estructura para tabla performance_schema.variables_info
...
CREATE TABLE `host_summary` (
	...
	`statement_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`statement_avg_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`table_scans` DECIMAL(65,0) NULL,
	`file_ios` DECIMAL(64,0) NULL,
	`file_io_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`current_connections` DECIMAL(41,0) NULL,
	`total_connections` DECIMAL(41,0) NULL,
	`unique_users` BIGINT(19) NOT NULL,
	`current_memory` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`total_memory_allocated` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_file_io` (
	...
	`io_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_file_io_type` (
	...
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`max_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_stages` (
	...
	`total` BIGINT(20) UNSIGNED NOT NULL,
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`avg_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `host_summary_by_statement_latency` (
	...
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`max_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`lock_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`cpu_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
...
CREATE TABLE `host_summary_by_statement_type` (
	...
	`full_scans` BIGINT(20) UNSIGNED NOT NULL
) ENGINE=MyISAM;
...
CREATE TABLE `innodb_buffer_stats_by_schema` (
	...
	`allocated` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`data` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`pages` BIGINT(19) NOT NULL,
	`pages_hashed` BIGINT(19) NOT NULL,
	`pages_old` BIGINT(19) NOT NULL,
	`rows_cached` DECIMAL(45,0) NULL
) ENGINE=MyISAM;
...
CREATE TABLE `innodb_lock_waits` (
	...
	`waiting_trx_id` BIGINT(20) UNSIGNED NOT NULL,
	`waiting_trx_started` DATETIME NOT NULL,
	`waiting_trx_age` TIME NULL,
	`waiting_trx_rows_locked` BIGINT(20) UNSIGNED NOT NULL,
	`waiting_trx_rows_modified` BIGINT(20) UNSIGNED NOT NULL,
	`waiting_pid` BIGINT(20) UNSIGNED NOT NULL,
	...
	`blocking_trx_id` BIGINT(20) UNSIGNED NOT NULL,
	`blocking_pid` BIGINT(20) UNSIGNED NOT NULL,
	...
	`blocking_trx_rows_locked` BIGINT(20) UNSIGNED NOT NULL,
	`blocking_trx_rows_modified` BIGINT(20) UNSIGNED NOT NULL,
	`sql_kill_blocking_query` VARCHAR(33) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`sql_kill_blocking_connection` VARCHAR(27) NOT NULL COLLATE 'utf8mb4_0900_ai_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `io_by_thread_by_latency` (
	...
	`total` DECIMAL(42,0) NULL,
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`min_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`avg_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`max_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
...
CREATE TABLE `io_global_by_file_by_bytes` (
	...
	`total_read` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`avg_read` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`count_write` BIGINT(20) UNSIGNED NOT NULL,
	`total_written` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`avg_write` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`total` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
...
CREATE TABLE `io_global_by_file_by_latency` (
	...
	`total_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`count_read` BIGINT(20) UNSIGNED NOT NULL,
	`read_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`count_write` BIGINT(20) UNSIGNED NOT NULL,
	`write_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`count_misc` BIGINT(20) UNSIGNED NOT NULL,
	`misc_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `io_global_by_wait_by_bytes` (
	...
	`count_write` BIGINT(20) UNSIGNED NOT NULL,
	`total_written` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`avg_written` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`total_requested` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `latest_file_io` (
	`thread` VARCHAR(317) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`file` VARCHAR(512) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`operation` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`requested` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `memory_by_host_by_current_bytes` (
	...
	`current_allocated` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`current_avg_alloc` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`current_max_alloc` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`total_allocated` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `memory_global_by_current_bytes` (
	`event_name` VARCHAR(128) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`current_count` BIGINT(19) NOT NULL,
	`current_alloc` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`current_avg_alloc` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`high_count` BIGINT(19) NOT NULL,
	`high_alloc` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`high_avg_alloc` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `processlist` (
	...
	`execution_engine` ENUM('PRIMARY','SECONDARY') NULL COLLATE 'utf8mb4_0900_ai_ci',
	`statement_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	...
	`last_statement_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`current_memory` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`last_wait` VARCHAR(128) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`last_wait_latency` VARCHAR(13) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`source` VARCHAR(64) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`trx_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
...
CREATE TABLE `schema_auto_increment_columns` (
	`table_schema` VARCHAR(64) NULL COLLATE 'utf8mb3_tolower_ci',
	`table_name` VARCHAR(64) NULL COLLATE 'utf8mb3_tolower_ci',
	`column_name` VARCHAR(64) NULL COLLATE 'utf8mb3_tolower_ci',
	`data_type` LONGTEXT NULL COLLATE 'utf8mb3_bin',
	`column_type` MEDIUMTEXT NOT NULL COLLATE 'utf8mb3_bin',
	`is_signed` INT(10) NOT NULL,
	`is_unsigned` INT(10) NOT NULL,
	`max_value` BIGINT(20) UNSIGNED NULL,
	`auto_increment` BIGINT(20) UNSIGNED NULL,
...
CREATE TABLE `schema_index_statistics` (
	...
	`select_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`rows_inserted` BIGINT(20) UNSIGNED NOT NULL,
	`insert_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`rows_updated` BIGINT(20) UNSIGNED NOT NULL,
	`update_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`rows_deleted` BIGINT(20) UNSIGNED NOT NULL,
	`delete_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- Volcando estructura para vista sys.schema_object_overview
-- Creando tabla temporal para superar errores de dependencia de VIEW
CREATE TABLE `schema_object_overview` (
	`db` VARCHAR(64) NULL COLLATE 'utf8mb3_tolower_ci',
	`object_type` VARCHAR(19) NULL COLLATE 'utf8mb3_bin',
...
CREATE TABLE `schema_redundant_indexes` (
	`table_schema` VARCHAR(64) NULL COLLATE 'utf8mb3_tolower_ci',
	`table_name` VARCHAR(64) NULL COLLATE 'utf8mb3_tolower_ci',
	`redundant_index_name` VARCHAR(64) NULL COLLATE 'utf8mb3_tolower_ci',
	`redundant_index_columns` TEXT NULL COLLATE 'utf8mb3_tolower_ci',
	`redundant_index_non_unique` INT(10) NULL,
	`dominant_index_name` VARCHAR(64) NULL COLLATE 'utf8mb3_tolower_ci',
	`dominant_index_columns` TEXT NULL COLLATE 'utf8mb3_tolower_ci',
	`dominant_index_non_unique` INT(10) NULL,
	`subpart_exists` INT(10) NOT NULL,
	`sql_drop_index` VARCHAR(223) NULL COLLATE 'utf8mb3_tolower_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `schema_table_lock_waits` (
	...
	`waiting_query` LONGTEXT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`waiting_query_secs` BIGINT(19) NULL,
...
CREATE TABLE `schema_table_statistics` (
	...
	`fetch_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`rows_inserted` BIGINT(20) UNSIGNED NOT NULL,
	`insert_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`rows_updated` BIGINT(20) UNSIGNED NOT NULL,
	`update_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	...
	`io_read` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`io_read_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`io_write_requests` DECIMAL(42,0) NULL,
	`io_write` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`io_write_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`io_misc_requests` DECIMAL(42,0) NULL,
	`io_misc_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `schema_table_statistics_with_buffer` (
	...
	`io_misc_requests` DECIMAL(42,0) NULL,
	`io_misc_latency` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`innodb_buffer_allocated` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`innodb_buffer_data` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`innodb_buffer_free` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`innodb_buffer_pages` BIGINT(19) NULL,
	`innodb_buffer_pages_hashed` BIGINT(19) NULL,
	`innodb_buffer_pages_old` BIGINT(19) NULL,
	`innodb_buffer_rows_cached` DECIMAL(45,0) NULL
) ENGINE=MyISAM;
...
CREATE TABLE `statements_with_full_table_scans` (
	...
	`rows_sent` BIGINT(20) UNSIGNED NOT NULL,
	`rows_examined` BIGINT(20) UNSIGNED NOT NULL,
	`rows_sent_avg` DECIMAL(21,0) NULL,
	`rows_examined_avg` DECIMAL(21,0) NULL,
	`first_seen` TIMESTAMP(6) NOT NULL,
	`last_seen` TIMESTAMP(6) NOT NULL,
	`digest` VARCHAR(64) NULL COLLATE 'utf8mb4_0900_ai_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `user_summary` (
	...
	`current_connections` DECIMAL(41,0) NULL,
	`total_connections` DECIMAL(41,0) NULL,
	`unique_hosts` BIGINT(19) NOT NULL,
	`current_memory` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci',
	`total_memory_allocated` VARCHAR(11) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `version` (
	...
	`mysql_version` VARCHAR(6) NOT NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `x$host_summary_by_statement_type` (
	...
	`cpu_latency` BIGINT(20) UNSIGNED NOT NULL,
	`rows_sent` BIGINT(20) UNSIGNED NOT NULL,
	`rows_examined` BIGINT(20) UNSIGNED NOT NULL,
	`rows_affected` BIGINT(20) UNSIGNED NOT NULL,
	`full_scans` BIGINT(20) UNSIGNED NOT NULL
...
CREATE TABLE `x$innodb_buffer_stats_by_schema` (
	`object_schema` TEXT NULL COLLATE 'utf8mb3_general_ci',
	`allocated` DECIMAL(44,0) NULL,
	`data` DECIMAL(44,0) NULL,
	`pages` BIGINT(19) NOT NULL,
	`pages_hashed` BIGINT(19) NOT NULL,
	`pages_old` BIGINT(19) NOT NULL,
	`rows_cached` DECIMAL(45,0) NOT NULL
) ENGINE=MyISAM;
...
CREATE TABLE `x$io_global_by_file_by_bytes` (
	...
	`count_read` BIGINT(20) UNSIGNED NOT NULL,
	`total_read` BIGINT(19) NOT NULL,
	`avg_read` DECIMAL(23,4) NOT NULL,
	`count_write` BIGINT(20) UNSIGNED NOT NULL,
	`total_written` BIGINT(19) NOT NULL,
...
CREATE TABLE `x$io_global_by_wait_by_bytes` (
	...
	`total_requested` BIGINT(19) NOT NULL
) ENGINE=MyISAM;
...
CREATE TABLE `x$memory_by_host_by_current_bytes` (
	...
	`current_max_alloc` BIGINT(19) NULL,
...
CREATE TABLE `x$memory_global_by_current_bytes` (
	`event_name` VARCHAR(128) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`current_count` BIGINT(19) NOT NULL,
	`current_alloc` BIGINT(19) NOT NULL,
	`current_avg_alloc` DECIMAL(23,4) NOT NULL,
	`high_count` BIGINT(19) NOT NULL,
	`high_alloc` BIGINT(19) NOT NULL,
...
CREATE TABLE `x$processlist` (
	...
	`cpu_latency` BIGINT(20) UNSIGNED NULL,
	`rows_examined` BIGINT(20) UNSIGNED NULL,
	`rows_sent` BIGINT(20) UNSIGNED NULL,
	`rows_affected` BIGINT(20) UNSIGNED NULL,
	`tmp_tables` BIGINT(20) UNSIGNED NULL,
...
CREATE TABLE `x$schema_flattened_keys` (
	`table_schema` VARCHAR(64) NULL COLLATE 'utf8mb3_tolower_ci',
	`table_name` VARCHAR(64) NULL COLLATE 'utf8mb3_tolower_ci',
	`index_name` VARCHAR(64) NULL COLLATE 'utf8mb3_tolower_ci',
	`non_unique` INT(10) NULL,
	`subpart_exists` BIGINT(19) NULL,
	`index_columns` TEXT NULL COLLATE 'utf8mb3_tolower_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `x$schema_table_statistics_with_buffer` (
	...
	`io_misc_requests` DECIMAL(42,0) NULL,
	`io_misc_latency` DECIMAL(42,0) NULL,
	`innodb_buffer_allocated` DECIMAL(44,0) NULL,
	`innodb_buffer_data` DECIMAL(44,0) NULL,
	`innodb_buffer_free` DECIMAL(45,0) NULL,
	`innodb_buffer_pages` BIGINT(19) NULL,
	`innodb_buffer_pages_hashed` BIGINT(19) NULL,
	`innodb_buffer_pages_old` BIGINT(19) NULL,
	`innodb_buffer_rows_cached` DECIMAL(45,0) NULL
...
CREATE TABLE `x$statement_analysis` (
	...
	`full_scan` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`exec_count` BIGINT(20) UNSIGNED NOT NULL,
	`exec_secondary_count` BIGINT(20) UNSIGNED NOT NULL,
	`err_count` BIGINT(20) UNSIGNED NOT NULL,
	`warn_count` BIGINT(20) UNSIGNED NOT NULL,
	`total_latency` BIGINT(20) UNSIGNED NOT NULL,
	`max_latency` BIGINT(20) UNSIGNED NOT NULL,
...
CREATE ALGORITHM=TEMPTABLE SQL SECURITY INVOKER VIEW `sys`.`x$memory_by_thread_by_current_bytes` (`thread_id`,`user`,`current_count_used`,`current_allocated`,`current_avg_alloc`,`current_max_alloc`,`total_allocated`) AS select `t`.`THREAD_ID` AS `thread_id`,if((`t`.`NAME` = 'thread/sql/one_connection'),concat(`t`.`PROCESSLIST_USER`,'@',convert(`t`.`PROCESSLIST_HOST` using utf8mb4)),replace(`t`.`NAME`,'thread/','')) AS `user`,sum(`mt`.`CURRENT_COUNT_USED`) AS `current_count_used`,sum(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) AS `current_allocated`,ifnull((sum(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) / nullif(sum(`mt`.`CURRENT_COUNT_USED`),0)),0) AS `current_avg_alloc`,max(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) AS `current_max_alloc`,sum(`mt`.`SUM_NUMBER_OF_BYTES_ALLOC`) AS `total_allocated` from (`performance_schema`.`memory_summary_by_thread_by_event_name` `mt` join `performance_schema`.`threads` `t` on((`mt`.`THREAD_ID` = `t`.`THREAD_ID`))) group by `t`.`THREAD_ID`,if((`t`.`NAME` = 'thread/sql/one_connection'),concat(`t`.`PROCESSLIST_USER`,'@',convert(`t`.`PROCESSLIST_HOST` using utf8mb4)),replace(`t`.`NAME`,'thread/','')) order by sum(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) desc;
...
CREATE ALGORITHM=TEMPTABLE SQL SECURITY INVOKER VIEW `sys`.`x$schema_table_lock_waits` (`object_schema`,`object_name`,`waiting_thread_id`,`waiting_pid`,`waiting_account`,`waiting_lock_type`,`waiting_lock_duration`,`waiting_query`,`waiting_query_secs`,`waiting_query_rows_affected`,`waiting_query_rows_examined`,`blocking_thread_id`,`blocking_pid`,`blocking_account`,`blocking_lock_type`,`blocking_lock_duration`,`sql_kill_blocking_query`,`sql_kill_blocking_connection`) AS select `g`.`OBJECT_SCHEMA` AS `object_schema`,`g`.`OBJECT_NAME` AS `object_name`,`pt`.`THREAD_ID` AS `waiting_thread_id`,`pt`.`PROCESSLIST_ID` AS `waiting_pid`,`sys`.`ps_thread_account`(`p`.`OWNER_THREAD_ID`) AS `waiting_account`,`p`.`LOCK_TYPE` AS `waiting_lock_type`,`p`.`LOCK_DURATION` AS `waiting_lock_duration`,`pt`.`PROCESSLIST_INFO` AS `waiting_query`,`pt`.`PROCESSLIST_TIME` AS `waiting_query_secs`,`ps`.`ROWS_AFFECTED` AS `waiting_query_rows_affected`,`ps`.`ROWS_EXAMINED` AS `waiting_query_rows_examined`,`gt`.`THREAD_ID` AS `blocking_thread_id`,`gt`.`PROCESSLIST_ID` AS `blocking_pid`,`sys`.`ps_thread_account`(`g`.`OWNER_THREAD_ID`) AS `blocking_account`,`g`.`LOCK_TYPE` AS `blocking_lock_type`,`g`.`LOCK_DURATION` AS `blocking_lock_duration`,concat('KILL QUERY ',`gt`.`PROCESSLIST_ID`) AS `sql_kill_blocking_query`,concat('KILL ',`gt`.`PROCESSLIST_ID`) AS `sql_kill_blocking_connection` from (((((`performance_schema`.`metadata_locks` `g` join `performance_schema`.`metadata_locks` `p` on(((`g`.`OBJECT_TYPE` = `p`.`OBJECT_TYPE`) and (`g`.`OBJECT_SCHEMA` = `p`.`OBJECT_SCHEMA`) and (`g`.`OBJECT_NAME` = `p`.`OBJECT_NAME`) and (`g`.`LOCK_STATUS` = 'GRANTED') and (`p`.`LOCK_STATUS` = 'PENDING')))) join `performance_schema`.`threads` `gt` on((`g`.`OWNER_THREAD_ID` = `gt`.`THREAD_ID`))) join `performance_schema`.`threads` `pt` on((`p`.`OWNER_THREAD_ID` = `pt`.`THREAD_ID`))) left join `performance_schema`.`events_statements_current` `gs` on((`g`.`OWNER_THREAD_ID` = `gs`.`THREAD_ID`))) left join `performance_schema`.`events_statements_current` `ps` on((`p`.`OWNER_THREAD_ID` = `ps`.`THREAD_ID`))) where (`g`.`OBJECT_TYPE` = 'TABLE');
...
CREATE ALGORITHM=TEMPTABLE SQL SECURITY INVOKER VIEW `sys`.`x$schema_table_statistics_with_buffer` (`table_schema`,`table_name`,`rows_fetched`,`fetch_latency`,`rows_inserted`,`insert_latency`,`rows_updated`,`update_latency`,`rows_deleted`,`delete_latency`,`io_read_requests`,`io_read`,`io_read_latency`,`io_write_requests`,`io_write`,`io_write_latency`,`io_misc_requests`,`io_misc_latency`,`innodb_buffer_allocated`,`innodb_buffer_data`,`innodb_buffer_free`,`innodb_buffer_pages`,`innodb_buffer_pages_hashed`,`innodb_buffer_pages_old`,`innodb_buffer_rows_cached`) AS select `pst`.`OBJECT_SCHEMA` AS `table_schema`,`pst`.`OBJECT_NAME` AS `table_name`,`pst`.`COUNT_FETCH` AS `rows_fetched`,`pst`.`SUM_TIMER_FETCH` AS `fetch_latency`,`pst`.`COUNT_INSERT` AS `rows_inserted`,`pst`.`SUM_TIMER_INSERT` AS `insert_latency`,`pst`.`COUNT_UPDATE` AS `rows_updated`,`pst`.`SUM_TIMER_UPDATE` AS `update_latency`,`pst`.`COUNT_DELETE` AS `rows_deleted`,`pst`.`SUM_TIMER_DELETE` AS `delete_latency`,`sys`.`fsbi`.`count_read` AS `io_read_requests`,`sys`.`fsbi`.`sum_number_of_bytes_read` AS `io_read`,`sys`.`fsbi`.`sum_timer_read` AS `io_read_latency`,`sys`.`fsbi`.`count_write` AS `io_write_requests`,`sys`.`fsbi`.`sum_number_of_bytes_write` AS `io_write`,`sys`.`fsbi`.`sum_timer_write` AS `io_write_latency`,`sys`.`fsbi`.`count_misc` AS `io_misc_requests`,`sys`.`fsbi`.`sum_timer_misc` AS `io_misc_latency`,`sys`.`ibp`.`allocated` AS `innodb_buffer_allocated`,`sys`.`ibp`.`data` AS `innodb_buffer_data`,(`sys`.`ibp`.`allocated` - `sys`.`ibp`.`data`) AS `innodb_buffer_free`,`sys`.`ibp`.`pages` AS `innodb_buffer_pages`,`sys`.`ibp`.`pages_hashed` AS `innodb_buffer_pages_hashed`,`sys`.`ibp`.`pages_old` AS `innodb_buffer_pages_old`,`sys`.`ibp`.`rows_cached` AS `innodb_buffer_rows_cached` from ((`performance_schema`.`table_io_waits_summary_by_table` `pst` left join `sys`.`x$ps_schema_table_statistics_io` `fsbi` on(((`pst`.`OBJECT_SCHEMA` = `sys`.`fsbi`.`table_schema`) and (`pst`.`OBJECT_NAME` = `sys`.`fsbi`.`table_name`)))) left join `sys`.`x$innodb_buffer_stats_by_table` `ibp` on(((`pst`.`OBJECT_SCHEMA` = `sys`.`ibp`.`object_schema`) and (`pst`.`OBJECT_NAME` = `sys`.`ibp`.`object_name`)))) order by `pst`.`SUM_TIMER_WAIT` desc;
...
-- Volcando estructura de base de datos para viernes18
CREATE DATABASE IF NOT EXISTS `viernes18` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `viernes18`;

-- Volcando estructura para tabla viernes18.city
...
-- Volcando estructura para tabla viernes18.country
...
-- Volcando estructura para tabla viernes18.countrylanguage
